...
INDIR="./01-SRAfastq_DRA005106/FASTQ"
OUTDIR="./02-Cutadapt_DRA005106"
FWSUF=_1.fastq.gz
RVSUF=_2.fastq.gz
FWSUF2=_trimmed_R1.fastq.gz # for trimmed forward-FASTQs
RVSUF2=_trimmed_R2.fastq.gz # for trimmed reverse-FASTQs
FWADAPT=^NNNNNNGTYGGTAAAWCTCGTGCCAGC
RVADAPT=^NNNNNNCATAGTGGGGTATCTAATCCYAGTTTG
...
# Primer trimming by cutadapt (ver3.5)
