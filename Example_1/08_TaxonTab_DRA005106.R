...
# Input and output
## Input R objects
path_input_seqID <- "./06-Merger_DRA005106/01-Saved_object/merged_seqID_tib.obj"
path_input_claid <- "./07-Claident_DRA005106/06-QCauto_MaxPOP05_MinSOR19+NN99.tsv"
## Output directory path
path_output <- "./08-TaxonTab_DRA005106"
