...
path_input_stats <- "./05-MiFishPL_DRA005106/01-PL_stats"
## Input: MiFish Pipeline result (xlsx) directory
path_input_results <- "./05-MiFishPL_DRA005106/02-PL_result"
## Output
path_mifish_out <- "./05-MiFishPL_DRA005106"
...
mifish_tib_1 <- make.mifish.tibble(mifish_results[-10])
mifish_tib_2 <- make.mifish.tibble(mifish_results[10], skip.first.rows=2) 
mifish_tib <- bind_rows(mifish_tib_1, mifish_tib_2)
