...
# Input and output
## Input R objects
path_input_seqID <- "./05-Merger_DRA009149/01-Saved_object/merged_seqID_tib.obj"
path_input_claid <- "./06-Claident_DRA009149/06-QCauto_MaxPOP05_MinSOR19+NN99.tsv"
## Output directory path
path_output <- "./07-TaxonTab_DRA009149"
...
# Add columns of sequence IDs of different pipelines: DADA2, Unoise3, and NODN (no denoising)
