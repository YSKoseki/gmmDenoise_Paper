...
path_input_primtrim <- "./02-Cutadapt_DRA009149/primtrim.tsv"
## Output
path_dada2_out <- "./03-DADA2_DRA009149"
...
getSequences(seq_tab_lfiltd) %>% 
  nchar() %>% 
  table()
## No abundance filtering (the code below is for consistency with the
##   other analysis
seq_tab_nfiltd <- seq_tab_lfiltd
seq_tab_nfiltd[seq_tab_nfiltd<1] <- 0L
