...
# Input and output
## Input R objects
path_input_seqID <- "./05-Merger_DRA006638/01-Saved_object/merged_seqID_tib.obj"
path_input_claid <- "./06-Claident_DRA006638/06-QCauto_MaxPOP05_MinSOR19+NN99.tsv"
## Output directory path
path_output <- "./07-TaxonTab_DRA006638"
