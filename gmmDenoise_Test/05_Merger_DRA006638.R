...
# Input and output
# List of file paths
path_merger_in <- list(dada="./03-DADA2_DRA006638/05-Saved_object/seqID_tib_dada.obj",
                      uno2="./04-UNOISE3_DRA006638/K_Saved_object/seqID_tib_uno2.obj",
                      nodn="./04-UNOISE3_DRA006638/K_Saved_object/seqID_tib_nodn.obj")
path_trueseq_in <- "05-Tsuji_etal_2020.fa"
## Output directory path
path_merger_out <- "./05-Merger_DRA006638"
...
merged_seqID_tib <- merged_seqID_tib %>%
  ...
  select(glob, dada, uno2, nodn, truehap, istruehap, seq)
