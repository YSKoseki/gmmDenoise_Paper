...
path_seq_tab <- list(dada="./03-DADA2_DRA010703/05-Saved_object/seq_tab_dada.obj",
                     uno5="./04-UNOISE3_DRA010703/G_Saved_object/seq_tab_uno5.obj",
                     uno2="./04-UNOISE3_DRA010703/G_Saved_object/seq_tab_uno2.obj",
                     mifs="./05-MiFishPL_DRA010703/03-Saved_object/seq_tab_mifs.obj")
path_taxon_tib <- "./08-TaxonTab_DRA010703/01-Saved_object/taxon_tib.obj"
path_sample_tib <- "./09-SampleDat_DRA010703/01-Saved_object/sample_tib.obj"
## Output directory
path_output <- "./10-Phyloseq_DRA010703"
...
##   it can take a few days or more!
set.seed(101)
bs <- treeGTR %>% 
  lapply(function(x) {
