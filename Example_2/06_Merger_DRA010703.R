...
# Input and output
# List of file paths
path_merger_in <- list(dada="./03-DADA2_DRA010703/05-Saved_object/seqID_tib_dada.obj",
                      uno5="./04-UNOISE3_DRA010703/G_Saved_object/seqID_tib_uno5.obj",
                      uno2="./04-UNOISE3_DRA010703/G_Saved_object/seqID_tib_uno2.obj",
                      mifs="./05-MiFishPL_DRA010703/03-Saved_object/seqID_tib_mifs.obj")
## Output directory path
path_merger_out <- "./06-Merger_DRA010703"
